...
/**
 * Ghost ingredient handler for ShuffleFilterScreen (18 slots)
 * Allows drag and drop from JEI/EMI into filter slots
 */
public class ShuffleFilterGhostHandler implements IGhostIngredientHandler<ShuffleFilterScreen> {
    
    @Override
    public <I> List<Target<I>> getTargetsTyped(@Nonnull ShuffleFilterScreen screen, @Nonnull ITypedIngredient<I> ingredient, boolean doStart) {
        ...
        // Get all slot widgets from both rows
